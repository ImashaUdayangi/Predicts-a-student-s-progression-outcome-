...
while True:
    ...
    total = crt_pass + crt_defer + crt_fail
    if total != 120:
    ...
    print(progression)
    stu_info[stu_id] = progression , crt_pass , crt_defer , crt_fail
    ...
    if repeat.lower() == "y":
        ...
        print("Part 4:")
        for m in stu_info.keys():
            outcome = stu_info[m]
            print(m,'-',outcome[0],':',outcome[1],',',outcome[2],',',outcome[3])
        break
    else:
        print("\nInavalid Input")
...
#references - https://www.w3schools.com/python/python_dictionaries.asp
